...
public class IspisRucnoSviranje extends Canvas implements Runnable{
	
	private Klavir klavir;
	private boolean nacinIspisa = true; //true za notni ispis, false za txt ispis
	...
	public boolean radi = false, kraj = false, pomeri = false;
	
	public IspisRucnoSviranje(Klavir k) {
		klavir = k;
